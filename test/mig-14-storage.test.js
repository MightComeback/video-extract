...
test('MIG-14: Heuristics - Storage > suggests checking S3 when S3 is mentioned directly', () => {
...
test('MIG-14: Heuristics - Storage/DB > suggests checking database when Supabase is mentioned', () => {
...
test('MIG-14: Heuristics - Storage/DB > suggests checking database when DynamoDB is mentioned', () => {
