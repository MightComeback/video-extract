...
test('normalizeUrlLike canonicalizes common provider URL variants', () => {
  ...
  // Provider parity: strip playlist params for canonical single-video URLs.
  assert.equal(
    normalizeUrlLike(`https://www.youtube.com/watch?v=${id}&list=PL1234567890ABCDE&index=4`),
  ...
  assert.equal(normalizeUrlLike('https://loom.com/1234567890abcdef'), 'https://loom.com/share/1234567890abcdef');
  assert.equal(
